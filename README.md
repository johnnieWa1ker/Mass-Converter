#  🔄 Mass Converter
[![Build Status](https://img.shields.io/badge/Swift-5.3-orange.svg)](https://swift.org)
...
The project is part of Paul Hudson's training cycle - 100 Days of SwiftUI
  ...
  <p float="right">
  <img src="Mass%20Сonverter/Assets.xcassets/demo-1.imageset/demo-1.png" width="32%"/>
  </p>
...
``` bash
git clone https://github.com/johnnieWa1ker/Mass-Converter.git
cd Mass-Converter
pod install
open Mass-Converter.xcodeproj.
```
